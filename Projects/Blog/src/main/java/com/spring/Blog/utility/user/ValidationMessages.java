...
public enum ValidationMessages {
    ...
    PASSWORD_IS_NOT_VALID("Password must be at least 6 characters and have at least one lowercase letter, one uppercase letter, one digit and one special character"),
